...
import { AccordionComponent, AccordionItemsDirective, AccordionItemDirective, Inject } from '@syncfusion/ej2-react-navigations';
import '@syncfusion/ej2-react-navigations/styles/material.css';
export class Accordion extends React.Component {
  render(){
    return (
      <div>
        <h2>Essential JS2 React Accordion Component</h2>
